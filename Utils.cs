...
public struct PlaceInBoard {
    public Towers cor { get; set;}
...
static class Utils{
    ...
    public static bool CanPlaceTower(List<PlaceInBoard> board, Towers tower, int posicao, int boardSize){
    ...
    public static bool CheckBoundaries(List<PlaceInBoard> board, Towers tower, int posicao, int boardSize, int nivel = 0)
    {
